-- =====================================================
-- CLEAN MIGRATION SCRIPT - FINAL VERSION
-- =====================================================
-- This script adds data safely without conflicts
-- =====================================================
...
-- Step 2: Add Insurance Companies (only if they don't exist)
...
-- Step 3: Add Policy Types (only if they don't exist)
...
-- Step 4: Add Claim Types (only if they don't exist)
...
-- Step 6: Add Sample Clients (only if they don't exist)
...
-- Step 7: Add Sample Addresses (only if they don't exist)
...
-- Step 8: Add Sample Policies with UNIQUE policy numbers
...
SELECT 
    ...
    i.id,
    p.id,
    'POL-MIG-001-2024',  -- Changed to unique number
    '2024-01-01'::date,
    '2024-12-31'::date,
...
SELECT 
    ...
    i.id,
    p.id,
    'POL-MIG-002-2024',  -- Changed to unique number
    '2024-02-01'::date,
    '2025-01-31'::date,
    'active'::policy_status,
    NOW(),
