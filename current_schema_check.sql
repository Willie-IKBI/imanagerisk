...
GRANT ALL ON TABLE "public"."claim_types" TO "anon";
GRANT ALL ON TABLE "public"."claim_types" TO "authenticated";
GRANT ALL ON TABLE "public"."claim_types" TO "service_role";
