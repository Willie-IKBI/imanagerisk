-- =====================================================
-- AZURE DATA EXTRACTION SCRIPT FOR IMR MIGRATION
-- =====================================================
-- Run this script against your Azure SQL Database
-- Export results to CSV files for each table
-- =====================================================
...
-- 7. INSURANCE POLICIES EXTRACTION
-- =====================================================
PRINT '=== EXTRACTING INSURANCE POLICIES ===';
-- Note: Adjust the table name based on your actual policy table name
SELECT 
    Insurance_ID_Key,
    ...
    Ins_Renewal_Date,
    'Extracted on: ' + CONVERT(VARCHAR, GETDATE(), 120) as extraction_date
FROM [Insurance_Policy_Table]  -- Replace with your actual table name
...
FROM dbo.address_dim
UNION ALL
SELECT 'Insurance_Policy_Table', COUNT(*)  -- Replace with actual table name
