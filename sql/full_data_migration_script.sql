-- =====================================================
-- FULL DATA MIGRATION SCRIPT - AZURE TO SUPABASE
-- =====================================================
...
-- Upload dbo.commercial_insurance_type_dim.csv to storage first, then run:
...
-- Upload dbo.personal_insurance_type_dim.csv to storage first, then run:
